...
plot(poissonest, pos = 6, what = c("dens", "marg", "IC", "D", "logL"), nrow = 2, ncol = 3, npts = 1000)
@
...
poissonclu <- RCLRMIX(x = poissonest, pos = 6, Zt = poisson@Zt)
...
\subsubsection{Plot method}
\begin{figure}[h]\centering
<<ex4_1-fig, fig = TRUE, pdf = TRUE, png = FALSE, eps = FALSE, height = 4.5, width = 5.5, echo = TRUE, results = hide, keep.source = FALSE>>=
...
\subsubsection{Clustering}
\begin{figure}[h]\centering
<<ex4_1-clu-fig, fig = TRUE, pdf = TRUE, png = FALSE, eps = FALSE, height = 4.5, width = 5.5, echo = TRUE, results = hide, keep.source = FALSE>>=
