...
<<galaxy-fig, fig = TRUE, height = 2.5, width = 5.5, echo = FALSE, results = hide, keep.source = FALSE>>=
## Visualize Figure 1.
...
@
\begin{figure}[tbh] \centering
<<iris-fig, fig = TRUE, height = 4.5, width = 5.5, echo = FALSE, results = hide, keep.source = FALSE>>=
## Visualize Figure 2.
...
<<complex1-fig, fig = TRUE, height = 2.5, width = 5.5, echo = false, keep.source = FALSE>>=
## Visualize Figure 3.
...
\begin{figure}[t]
\centering
<<complex2-fig, fig = TRUE, height = 6.5, width = 7.5, echo = false, keep.source = FALSE>>=
## Visualize Figure 4.
